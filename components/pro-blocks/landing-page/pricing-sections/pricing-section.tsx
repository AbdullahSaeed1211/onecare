  ...
  plans: [
    {
      ...
      features: [
        { name: "50-minute weekly sessions", tooltip: "One session per week with your dedicated therapist" },
        {
          name: "Licensed therapists",
          tooltip: "All therapists are fully licensed and experienced",
        },
        { name: "Flexible scheduling", tooltip: "Book sessions that fit your schedule" },
        { name: "Progress tracking", tooltip: "Monitor your mental health journey" },
      ],
      price: 120,
      period: "/month",
      variant: "outline",
    },
    {
      ...
      features: [
        { name: "Everything in Individual Therapy", tooltip: "Includes all individual therapy benefits" },
        { name: "Psychiatrist consultations", tooltip: "Access to medication management when needed" },
        { name: "Holistic wellness guidance", tooltip: "Nutrition, exercise, and mindfulness support" },
        { name: "Crisis support", tooltip: "24/7 access to mental health professionals during crises" },
        { name: "Family sessions", tooltip: "Involve loved ones in your care when appropriate" },
      ],
      price: 250,
      period: "/month",
      variant: "default",
